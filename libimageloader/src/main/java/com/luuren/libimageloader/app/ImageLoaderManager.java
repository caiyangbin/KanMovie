//package org.egreat.libimageloader.app;
//
...
//     * 为非view加载图片
//     */
//    private void displayImageForTarget(Context context, Target target, int resId, String url) {
//        this.displayImageForTarget(context, target, url, resId, null);
//    }
//
//    /**
//     * 为非view加载图片
//     */
//    private void displayImageForTarget(Context context, Target target, String url, int resId,
//                                       CustomRequestListener requestListener) {
//        Glide.with(context)
//                .asBitmap()
//                .load(url)
//                .apply(initCommonRequestOption(resId))
//                .transition(withCrossFade())
//                .fitCenter()
...
//    private RequestOptions initCommonRequestOption(int resId) {
